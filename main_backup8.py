...
<style>
    ...
    /* Readability fix: force dark text on the light content/chat area. */
...
def fetch_commons_topic_images(search_query: str, max_images: int = 2):
    ...
    if topic_items:
        for exact_item in topic_items:
            ...
            for q in exact_queries:
                imgs = fetch_commons_topic_images(q, max_images=2)
                if imgs:
                    item_found = imgs
                    break
